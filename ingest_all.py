...
def clean_text(text: str) -> str:
    """Basis opschoning van witruimte."""
    text = re.sub(r"\n{3,}", "\n\n", text)
    ...
    for site_id, label in sites:
        ...
        if sp_pages:
          for page in sp_pages:
            ...
            new_doc.excluded_embed_metadata_keys = ["url"]
        ...
        for file in sp_files:
            ...
            if download_sharepoint_file(dl_url, file_path):
                ...
                for d in file_docs:
                    ...
                    d.excluded_embed_metadata_keys = ["url", "download_url"]
                    all_docs.append(d)
            else:
...
def build_index(documents):
    ...
    index = VectorStoreIndex.from_documents(
        ...
        transformations=[SentenceSplitter(chunk_size=650, chunk_overlap=100)],
        show_progress=True
    )
